INSERT INTO users(nickname, email, password, status_id) values ('paolo1967', 'paolo@polito.it', crypt('paolo', gen_salt('bf')), 1);
INSERT INTO users(nickname, email, password, status_id) values ('alessia1994', 'alessia@polito.it', crypt('alessia', gen_salt('bf')), 1);
INSERT INTO users(nickname, email, password, status_id) values ('andrea1949', 'andrea@polito.it', crypt('andrea', gen_salt('bf')), 1);
INSERT INTO users(nickname, email, password, status_id) values ('bea2005', 'beatrice@polito.it', crypt('beatrice', gen_salt('bf')), 1);
INSERT INTO users(nickname, email, password, status_id) values ('martino', 'martino@polito.it', crypt('martino', gen_salt('bf')), 1);
INSERT INTO users(nickname, email, password, status_id) values ('alessio', 'alessio@polito.it', crypt('alessio', gen_salt('bf')), 1);
INSERT INTO users(nickname, email, password, status_id) values ('riccardo', 'riccardo@polito.it', crypt('riccardo', gen_salt('bf')), 1);
